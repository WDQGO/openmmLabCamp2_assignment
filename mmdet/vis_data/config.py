...
log_level = 'INFO'
load_from = 'D:/ACanaconda/jupyternotebookPro/01OpenmmlabTwo/work_dirs/rtmdet_tiny_1xb12-40e_balloon/best_coco_bbox_mAP_epoch_30.pth'
resume = False
train_cfg = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='E:/dataSetCollect/balloon_dataset/balloon/',
        ann_file=
        'E:/dataSetCollect/balloon_dataset/balloon/train/balloon_train.json',
        data_prefix=dict(
            img='E:/dataSetCollect/balloon_dataset/balloon/train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='E:/dataSetCollect/balloon_dataset/balloon/',
        ann_file=
        'E:/dataSetCollect/balloon_dataset/balloon/val/balloon_val.json',
