...
data_mode = 'topdown'
data_root = 'E:\\dataSetCollect\\MMPose\\Ear210_Keypoint_Dataset_coco/'
dataset_info = dict(
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file=
        'E:\\dataSetCollect\\MMPose\\Ear210_Keypoint_Dataset_coco/val_coco.json'
    ),
...
launcher = 'none'
work_dir = 'D:\\ACpycharm\\myProjeycs\\mmpose-main\\tools\\work_dirs\\rtmpose-s-ear0604'
